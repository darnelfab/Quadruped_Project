...
class groupService:
	...
	def __init__(self):
		...
		self.left_hip_1_joint =moveit_commander.MoveGroupCommander("left_hip_1_joint")
		self.left_hip_2_joint =moveit_commander.MoveGroupCommander("left_hip_2_joint")
		self.right_hip_1_joint =moveit_commander.MoveGroupCommander("right_hip_1_joint")
		self.right_hip_2_joint =moveit_commander.MoveGroupCommander("right_hip_2_joint")
	...
	def handle_req(self,req):
		try:
			...
			self.left_hip_1_joint.set_named_target("left_hip_1_joint_fwd")
			self.left_hip_2_joint.set_named_target("left_hip_2_joint_fwd")
			self.right_hip_1_joint.set_named_target("right_hip_1_joint_fwd")
			self.right_hip_2_joint.set_named_target("right_hip_2_joint_fwd")
			count=0
